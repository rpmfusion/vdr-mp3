...
%changelog
* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.10.5-11
- Rebuilt for new VDR 2.8.1 API version 12

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.10.5-10
- Rebuilt for new VDR API version 2.7.9

* Tue Feb 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.10.5-9
- Rebuilt for new VDR API version 2.7.8

* Mon Feb 02 2026 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.10.5-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Aug 01 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.10.5-7
- Rebuilt for new VDR API version 2.7.7

* Sun Jul 27 2025 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.10.5-6
...
* Sun Dec 18 2022 Martin Gansser <martinkg@fedoraproject.org> - 0.10.4-8
- Rebuilt for new VDR API version

* Sat Dec 03 2022 Martin Gansser <martinkg@fedoraproject.org> - 0.10.4-7
- Rebuilt for new VDR API version

* Mon Aug 08 2022 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 0.10.4-6
